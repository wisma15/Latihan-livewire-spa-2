            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                        <button wire:click.prevent="delete({{ $deleteId }})" type="button"
...
<div class="py-12 ">
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
        @if (session()->has('message'))
            <div class="bg-gradient-to-r from-green-400 to-blue-500 text-white px-4 py-3 shadow-md my-3 rounded"
                role="alert">
                <div class="flex">
                    <div>
        ...
        @if (session()->has('errMessage'))
            <div class="bg-gradient-to-r from-red-400 to-yellow-500 text-white px-4 py-3 shadow-md my-3 rounded"
                role="alert">
                <div class="flex">
                    <div>
        ...
        <div class="bg-gray-100 overflow-hidden sm:rounded-lg">
            ...
            <button wire:click="openModal()"
                class="px-10 py-2 bg-blue-500 text-white ml-24 rounded-xl">
                Tambah
            </button>
                                    ...
                                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                                        <td class="py-3 px-6 text-left whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="mr-2">
                                                    <img src="{{ asset('storage/' . $item->file_name) }}" width="70"
                                                        alt="">
                                                </div>
                                        ...
                                        <td class="py-3 px-6 text-center">
                                            <span class="text-xs">
                                                {{ $item->kategori()->get()->implode('nama_produk')}}
                                            </span>
                                        </td>
                                        <td class="py-3 px-6 text-center">
                                            <span class="text-xs">
